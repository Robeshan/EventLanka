...
<form action="../bacend_logics_scripts/register_service_provider.php" method="post" enctype="multipart/form-data">
        ...
        <input type="text" name="providerName" required placeholder="Enter your Business/Provider Name">
        <input type="email" name="email" required placeholder="Enter your Email">
        <input type="text" name="contactInfo" required placeholder="Enter your Contact Number">
        
       

        <!-- User Details -->
        <input type="text" name="username" required placeholder="Create a Username">
        <input type="password" name="password" required placeholder="Create a Password" pattern=".{6,}" title="Six or more characters">
        <input type="password" name="cpassword" required placeholder="Confirm your Password" pattern=".{6,}" title="Six or more characters">

         <textarea name="serviceDetails" required placeholder="Describe the services you provide"></textarea>
        ...
        <input type="submit" name="submit" value="Register Now" class="form-btn"><center>
        <p>Already have an account? <a href="login_form.php">Login now</a></p></center>
    </form>
</div>
